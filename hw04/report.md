...
# 5. Измените параметры PostgreSQL для получения максимальной производительности; / 6. Перезапустите кластер (если требуется) и повторите pgbench с теми же настройками; / Сравните tps до/после и сделайте вывод, какие изменения дали эффект;
